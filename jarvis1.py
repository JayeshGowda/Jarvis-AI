...
while True:
    ...
    if 'according to wikipedia' in query.lower():
        ...
        speak("my boss is jaeyaesh gowda.....age is 18")
    ...
    elif 'turn on the camera' in query.lower():
        speak("as you wish")
        os.system("python face_detection_live.py")

    elif 'bye jarvis' in query.lower():
        ...
        webbrowser.open(
            "www.aha-music.com/identify-songs-music-recognition-online#record-div")
        ...
        codepath = "C:\\Users\\lenovo\\Desktop\\jarvis1.py"
    ...
    elif 'email to alex' in query.lower():
        try:
